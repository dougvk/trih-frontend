...
export default function SidebarToggle({ isOpen, onClick }: SidebarToggleProps) {
  return (
    ...
    >
      ...
      {/* Button content */}
      <div className="relative z-10 flex items-center justify-center h-full w-full bg-[#fff4da] rounded-lg border-2 border-gray-900 hover:-translate-y-0.5 hover:-translate-x-0.5 transition-transform duration-200">
        <svg
